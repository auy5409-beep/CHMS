...
<body class="bg-gray-50 font-sans">
  ...
  <header class="bg-green-700 text-white shadow-md fixed top-0 w-full z-50">
    <div class="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
      ...
      <nav class="space-x-6">
        ...
        <a href="login.php" class="bg-white text-green-700 px-4 py-2 rounded-lg font-semibold hover:bg-green-100 transition">Login</a>
      </nav>
    </div>
  </header>
  ...
  <section id="home" class="relative h-screen flex items-center justify-center text-center text-white overflow-hidden">
    ...
    <div class="relative z-10 max-w-3xl mx-auto px-4 fade-in">
      ...
      <a href="login.php" class="bg-white text-green-700 px-8 py-3 rounded-lg font-semibold shadow-lg hover:bg-green-100 transition transform hover:scale-105">Get Started</a>
    </div>
